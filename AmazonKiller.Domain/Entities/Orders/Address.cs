...
public class Address
{
    ...
    [Required] [StringLength(20)] public string HouseNumber { get; set; } = string.Empty;

    [StringLength(20)] public string? ApartmentNumber { get; set; }

    [Required] [StringLength(20)] public string PostCode { get; set; } = string.Empty;
}