...
public static class ControllerExtensions
{
    ...
    {
        return controller.Problem(title: "Not found", detail: detail, statusCode: StatusCodes.Status404NotFound);
    }

    public static IActionResult ProblemBadRequest(this ControllerBase controller, string detail)
    {
        return controller.Problem(title: "Bad request", detail: detail, statusCode: StatusCodes.Status400BadRequest);
    }
}