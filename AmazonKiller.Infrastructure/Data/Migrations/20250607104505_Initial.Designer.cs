...
namespace AmazonKiller.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250607104505_Initial")]
            ...
            modelBuilder.Entity("AmazonKiller.Domain.Entities.Collections.Collection", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://cdn.shopify.com/s/files/1/0340/3975/8907/products/WH1000XM5B_1.jpg?v=1652359353&width=364",
                            IsActive = true,
                            MaxPrice = 400m,
                            MinPrice = 300m,
                            RowVersion = new byte[0],
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnroSazOZgAVDY26rzWBoIGhKhi7s5JDOgAw&s",
                            IsActive = true,
                            MaxPrice = 160m,
                            MinPrice = 120m,
                            RowVersion = new byte[0],
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-kEDvzQ7aygIbrsTVd6vMex27pGFF1nj_Og&s",
                            IsActive = true,
                            MaxPrice = 250m,
                            MinPrice = 200m,
                            RowVersion = new byte[0],
            ...
            modelBuilder.Entity("AmazonKiller.Domain.Entities.Reviews.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ImageUrls = "[\"https://www.trustedreviews.com/wp-content/uploads/sites/7/2023/02/Samsung-Galaxy-S23-review-4-scaled.jpg\",\"https://cdn.mos.cms.futurecdn.net/qUaKQ3tLp9kz77mNJswNw5.jpg\"]",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ImageUrls = "[\"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMqiHMcxsM6_WGsFNyUeOmRJiA8m4PXYlu0w\\u0026s\"]",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ImageUrls = "[\"https://i.rtings.com/assets/products/qh2fKaXG/dyson-v15s-detect-submarine/design-medium.jpg?format=auto\",\"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6Dl9H-VVAlhTl4IORL2MROelfDITfUl1v2A\\u0026s\"]",
